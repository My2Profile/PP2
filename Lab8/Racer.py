...
#image_player_car
image=pygame.image.load(r"C:\Users\Администратор\Desktop\PP2\Lab8\yellow.png")
rect=image.get_rect()
rect.center=(300,500)

#image_enemy_car
image2=pygame.image.load(r"C:\Users\Администратор\Desktop\PP2\Lab8\red.png")
rect2=image2.get_rect()
rect2.center=(random.randint(40,370),0)

#image_coin
image3=pygame.image.load(r"C:\Users\Администратор\Desktop\PP2\Lab8\coin.png")
image3=pygame.transform.scale(image3,(50,50))
rect3=image3.get_rect()
rect3.center=(random.randint(150,370),0)

#road
image_road=pygame.image.load(r"C:\Users\Администратор\Desktop\PP2\Lab8\Street.png")
