...
def show_score( color, font, size):
    ...
    score_font = pygame.font.Font(r"C:\Users\Администратор\Desktop\PP2\Lab8\Font.ttf", 50)
...
def game_over():
    ...
    my_font = pygame.font.SysFont(r"C:\Users\Администратор\Desktop\PP2\Lab8\Font.ttf", 50)
...
while True:
    ...
    if  fruit_spawn==0:
        fruit_position[0] = random.randint(10,600//10-10)*10
        #print(fruit_position[0])
        fruit_position[1]=random.randint(10,600//10-10)*10
